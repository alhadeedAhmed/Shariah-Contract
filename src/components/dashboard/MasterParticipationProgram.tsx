      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div className="flex-1 space-y-4">
            ...
            >
              Streamline your Islamic Economy contracts with our enhanced Master
              Participation Agreement (MPA) workflow. Get instant access to
              Shariah-compliant templates and automated validation.
            </motion.p>
          </div>
          ...
          >
            ...
            <Button className="bg-gradient-to-r from-[#4A0404] to-[#4A0404]/90 hover:from-[#4A0404]/90 hover:to-[#4A0404] text-white shadow-lg hover:shadow-xl transition-all duration-300 px-6">
              Start MPA Workflow
          ...
          {[
            {
              ...
              description:
                "AI-powered Shariah compliance validation with real-time feedback",
            },
            {
              title: "Scholar Network",
              description:
                "Direct access to our network of certified Shariah scholars",
            },
            {
            ...
            >
              <h3 className="text-lg font-medium text-[#4A0404] mb-2">
                {feature.title}
              </h3>
