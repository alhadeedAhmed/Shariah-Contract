      ...
      >
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-[#4A0404] tracking-tight">Recent Contracts</h2>
              <p className="text-[#B4925F] mt-1">Your latest Islamic finance contracts</p>
            </div>
          </div>
          {hasContracts && (
            <Button 
        ...
        {!hasContracts ? (
          ...
          >
            ...
            <h3 className="text-xl font-medium text-[#4A0404] mb-2">No contracts yet</h3>
            <p className="text-[#B4925F] mb-6 max-w-md mx-auto">
              Start by creating your first Islamic finance contract with our enhanced validation system
            </p>
            <motion.div
            ...
            >
              <Button 
                className="bg-gradient-to-r from-[#4A0404] to-[#4A0404]/90 hover:from-[#4A0404]/90 hover:to-[#4A0404] text-white shadow-lg hover:shadow-xl transition-all duration-300"
              >
