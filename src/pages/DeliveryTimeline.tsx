  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-maroon/5 via-background to-golden/5">
      ...
      <div className="container mx-auto px-4 sm:px-8 py-10 space-y-8">
        ...
        >
          <Card className="p-6 sm:p-8 bg-white/90 backdrop-blur-md border border-maroon/20 rounded-2xl shadow-lg">
            {/* Header */}
            ...
            <ol className="space-y-6">
              {steps.map((s, i) => (
                ...
                >
                  <div className="p-3 rounded-xl bg-gradient-to-br from-maroon/10 to-maroon/5 shadow-md">
                    <s.icon className="h-6 w-6 text-maroon" />
                  </div>
                  <div>
                    <p className="text-maroon font-semibold text-lg">
                      {s.title}
                    </p>
                    <p className="text-sm text-golden">{s.desc}</p>
                  </div>
                </motion.li>
              ))}
            </ol>
            ...
            >
              ...
              <Link to="/vehicle-services">
                <Button className="flex items-center gap-2 bg-gradient-to-r from-maroon to-maroon/90 text-white px-6 py-2 rounded-xl shadow hover:shadow-lg transition">
